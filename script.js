...
somVencedor.volume = 0.8; // ajuste se quiser
...
// tempo X para parar o tempo de som do vencedor (em milissegundos)
setTimeout(() => {
    somVencedor.pause();
    somVencedor.currentTime = 0; // opcional: volta ao início
}, 4000); // <-- aqui você coloca o tempo desejado
